...
const CancelConfirm = ({ open, handleClose, handleFetchOrder }: Props) => {
    ...
    const { mutate } = useMutation({
        mutationFn: async ({ open, note, cancelBy = "user" }: IRes) => {
                            ...
                            <DialogDescription className="text-[#FFB22C] my-3">
                                <p className="flex ">
                                    <AiFillExclamationCircle
                                        ...
                                        size={24}
                                    />{" "}
                                    Vui lòng chọn lý do hủy đơn hàng. Lưu ý:
                                    Thao tác này sẽ hủy tất cả sản phẩm có trong
                                    đơn hàng và không thể hoàn tác.
                                </p>
                            </DialogDescription>
                        </div>
                    </DialogHeader>
